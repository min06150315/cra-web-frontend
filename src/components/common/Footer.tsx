...
export const Footer = () => {
  return (
    <footer className="text-base font-semibold border-t-2 border-black text-black">
      <div className="mx-auto max-w-7xl px-6 py-12 md:py-16">
        <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-10 pb-12 border-b-2 border-black">
